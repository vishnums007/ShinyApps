  ...
  output$add_stocks_ui<-renderUI({
    ...
    fluidPage(
      fluidRow(
        ...
        hit submit. Then, you will be asked to verify the information you provided and
  ...
  output$about_ui<- renderUI({
    ...
    fluidPage(
      ...
      wellPanel(
        ...
        hr(),
        p(style="text-align: justify", em("This website is currently at its very first version (v1.0.0, last updated: 21-July-2023).
