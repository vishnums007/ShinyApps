  ...
  output$about_ui<- renderUI({
    ...
    fluidPage(
      ...
      wellPanel(
        ...
        hr(),
        p(style="text-align: justify;font-size:16px", ("This website is currently at its very first versions (v1.0.1, last updated: 31-August-2023).
