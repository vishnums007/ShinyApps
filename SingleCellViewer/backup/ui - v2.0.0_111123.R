...
ui <-navbarPage(
  theme = bs_theme(version=4, bootswatch = "flatly"),title = "Zebrafish Spinal Cord Regeneration Atlas",
             ...
             tabPanel("Visualize Markers",
                      ...
                      navlistPanel(
                        tabPanel("Dot Plot",
                                 ...
                                 h5(style=  "color:blue","Note: Note: If the plot legends are not visible, please download the plot")
                                 ),
